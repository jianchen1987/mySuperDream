//
//  WMShoppingCartTableViewCell+Skeleton.m
//  SuperApp
//
...
@implementation WMShoppingCartTableViewCell (Skeleton)
...
- (NSArray<HDSkeletonLayer *> *)skeletonLayoutViews {
    ...
    [c0 hd_makeFrameLayout:^(HDFrameLayoutMaker *_Nonnull make) {
        ...
        make.centerY.hd_equalTo(WMShoppingCartTableViewCell.skeletonViewHeight * 0.5);
        make.left.hd_equalTo(15);
    }];
    c0.skeletonCornerRadius = iconW * 0.5;

    HDSkeletonLayer *r0 = [[HDSkeletonLayer alloc] init];
    const CGFloat r0W = WMShoppingCartTableViewCell.skeletonViewHeight - 2 * 15;
