...
@interface WMNewHomeViewController ()
/// 内容
@property (nonatomic, strong) WMNewHomeView *contentView;
/// VM
...
@implementation WMNewHomeViewController
...
- (WMNewHomeView *)contentView {
    if (!_contentView) {
        _contentView = [[WMNewHomeView alloc] initWithViewModel:self.viewModel];
        @HDWeakify(self);
...
- (WMNewHomeViewModel *)viewModel {
    if (!_viewModel) {
        _viewModel = [[WMNewHomeViewModel alloc] init];
