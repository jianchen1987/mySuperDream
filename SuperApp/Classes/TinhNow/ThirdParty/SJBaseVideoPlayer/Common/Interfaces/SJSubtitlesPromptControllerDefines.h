...
static inline SJTimeRange SJMakeTimeRange(NSTimeInterval start, NSTimeInterval duration) {
    return (SJTimeRange){start, duration};
}

static inline BOOL SJTimeRangeContainsTime(NSTimeInterval time, SJTimeRange range) {
