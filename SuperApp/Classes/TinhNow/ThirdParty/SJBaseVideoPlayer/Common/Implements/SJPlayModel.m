...
- (void)setNextPlayModel:(nullable __kindof SJPlayModel *)nextPlayModel {
    ...
    //
    //
    if ([nextPlayModel isKindOfClass:SJCollectionViewCellPlayModel.class] || [nextPlayModel isKindOfClass:SJCollectionViewSectionHeaderViewPlayModel.class] ||
        [nextPlayModel isKindOfClass:SJCollectionViewSectionFooterViewPlayModel.class] || [nextPlayModel isKindOfClass:SJTableViewCellPlayModel.class] ||
        [nextPlayModel isKindOfClass:SJTableViewSectionHeaderViewPlayModel.class] || [nextPlayModel isKindOfClass:SJTableViewSectionFooterViewPlayModel.class]) {
        // 当前嵌入的CollectionView需要一个标识(SJPlayModelNestedView), 以便能够在复用的情况下也能获取到它

        NSAssert([_collectionView conformsToProtocol:@protocol(SJPlayModelNestedView)] || nextPlayModel.scrollViewSelector != NULL || nextPlayModel.superviewSelector != NULL,
...
- (nullable __kindof UIScrollView *)inScrollView {
    ...
    if ([next isKindOfClass:SJCollectionViewCellPlayModel.class] || [next isKindOfClass:SJTableViewCellPlayModel.class]) {
        return next.scrollViewSelector != NULL ? [[next inScrollView] viewForSelector:next.scrollViewSelector atIndexPath:next.indexPath] :
    ...
    if ([next isKindOfClass:SJCollectionViewSectionHeaderViewPlayModel.class] || [next isKindOfClass:SJTableViewSectionHeaderViewPlayModel.class]) {
        return next.scrollViewSelector != NULL ? [[next inScrollView] viewForSelector:next.scrollViewSelector inHeaderForSection:next.section] :
    ...
    if ([next isKindOfClass:SJCollectionViewSectionFooterViewPlayModel.class] || [next isKindOfClass:SJTableViewSectionFooterViewPlayModel.class]) {
        return next.scrollViewSelector != NULL ? [[next inScrollView] viewForSelector:next.scrollViewSelector inFooterForSection:next.section] :
...
- (instancetype)initWithPlayerSuperview:(__unused UIView *)playerSuperview atIndexPath:(__strong NSIndexPath *)indexPath tableView:(__weak UITableView *)tableView {
    return [self initWithPlayerSuperviewTag:playerSuperview.tag atIndexPath:indexPath tableView:tableView];
}
- (instancetype)initWithPlayerSuperviewTag:(NSInteger)playerSuperviewTag atIndexPath:(__strong NSIndexPath *)indexPath tableView:(__weak UITableView *)tableView {
...
- (instancetype)initWithPlayerSuperview:(__unused UIView *)playerSuperview atIndexPath:(__strong NSIndexPath *)indexPath collectionView:(__weak UICollectionView *)collectionView {
    return [self initWithPlayerSuperviewTag:playerSuperview.tag atIndexPath:indexPath collectionView:collectionView];
}

- (instancetype)initWithPlayerSuperviewTag:(NSInteger)playerSuperviewTag atIndexPath:(__strong NSIndexPath *)indexPath collectionView:(__weak UICollectionView *)collectionView {
    NSParameterAssert(playerSuperviewTag != 0);
    NSParameterAssert(indexPath);
...
- (instancetype)initWithPlayerSuperview:(UIView *_Nonnull __weak)playerSuperview tableView:(UITableView *_Nonnull __weak)tableView {
...
- (instancetype)initWithPlayerSuperviewTag:(NSInteger)playerSuperviewTag inSection:(NSInteger)inSection isHeader:(BOOL)isHeader tableView:(UITableView *_Nonnull __weak)tableView {
    NSParameterAssert(playerSuperviewTag != 0);
    NSParameterAssert(tableView);
...
- (UIView *_Nullable)playerSuperview {
    return _isHeader ? [[[self tableView] headerViewForSection:_inSection] viewWithTag:_playerSuperviewTag] : [[[self tableView] footerViewForSection:_inSection] viewWithTag:_playerSuperviewTag];
}
- (nullable __kindof UIScrollView *)inScrollView {
    return _tableView;
}
...
+ (instancetype)UITableViewCellPlayModelWithPlayerSuperviewTag:(NSInteger)playerSuperviewTag atIndexPath:(__strong NSIndexPath *)indexPath tableView:(__weak UITableView *)tableView {
...
+ (instancetype)UITableViewHeaderViewPlayModelWithPlayerSuperview:(__weak UIView *)playerSuperview tableView:(__weak UITableView *)tableView {
...
+ (instancetype)UICollectionViewNestedInUITableViewCellPlayModelWithPlayerSuperviewTag:(NSInteger)playerSuperviewTag
                                                             ...
                                                             collectionViewAtIndexPath:(__strong NSIndexPath *)collectionViewAtIndexPath
                                                                             tableView:(__weak UITableView *)tableView {
    return [[SJUICollectionViewNestedInUITableViewCellPlayModel alloc] initWithPlayerSuperviewTag:playerSuperviewTag atIndexPath:indexPath collectionViewTag:collectionViewTag
                                                                        collectionViewAtIndexPath:collectionViewAtIndexPath
                                                                                        tableView:tableView];
}
...
+ (instancetype)UICollectionViewNestedInUICollectionViewCellPlayModelWithPlayerSuperviewTag:(NSInteger)playerSuperviewTag
                                                                  ...
                                                                  collectionViewAtIndexPath:(__strong NSIndexPath *)collectionViewAtIndexPath
                                                                         rootCollectionView:(__weak UICollectionView *)rootCollectionView {
    return [[SJUICollectionViewNestedInUICollectionViewCellPlayModel alloc] initWithPlayerSuperviewTag:playerSuperviewTag atIndexPath:indexPath collectionViewTag:collectionViewTag
                                                                             collectionViewAtIndexPath:collectionViewAtIndexPath
                                                                                    rootCollectionView:rootCollectionView];
}
