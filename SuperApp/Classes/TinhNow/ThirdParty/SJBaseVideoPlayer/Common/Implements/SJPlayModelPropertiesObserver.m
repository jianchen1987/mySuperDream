...
- (void)_observeProperties {
    if ([_playModel isKindOfClass:SJScrollViewPlayModel.class] || [_playModel isKindOfClass:SJCollectionViewCellPlayModel.class] ||
        [_playModel isKindOfClass:SJCollectionViewSectionHeaderViewPlayModel.class] || [_playModel isKindOfClass:SJCollectionViewSectionFooterViewPlayModel.class] ||
        [_playModel isKindOfClass:SJTableViewCellPlayModel.class] || [_playModel isKindOfClass:SJTableViewSectionHeaderViewPlayModel.class] ||
        [_playModel isKindOfClass:SJTableViewSectionFooterViewPlayModel.class] || [_playModel isKindOfClass:SJTableViewTableHeaderViewPlayModel.class] ||
...
- (void)_scrollViewDidScroll:(UIScrollView *)scrollView {
    if (!scrollView)
        return;
    if (CGPointEqualToPoint(_beforeOffset, scrollView.contentOffset))
        return;
...
- (BOOL)isScrolling {
    ...
    // 以下已弃用, 未来可能会删除
        ...
        SJUICollectionViewNestedInUITableViewHeaderViewPlayModel *playModel = _playModel;
        return playModel.collectionView.isDragging || playModel.collectionView.isDecelerating || playModel.tableView.isDragging || playModel.tableView.isDecelerating;
    } else if ([_playModel isKindOfClass:[SJUICollectionViewNestedInUITableViewCellPlayModel class]]) {
        SJUICollectionViewNestedInUITableViewCellPlayModel *playModel = _playModel;
        return playModel.collectionView.isDragging || playModel.collectionView.isDecelerating || playModel.tableView.isDragging || playModel.tableView.isDecelerating;
    } else if ([_playModel isKindOfClass:[SJUICollectionViewNestedInUICollectionViewCellPlayModel class]]) {
        SJUICollectionViewNestedInUICollectionViewCellPlayModel *playModel = _playModel;
        return playModel.collectionView.isDragging || playModel.collectionView.isDecelerating || playModel.rootCollectionView.isDragging || playModel.rootCollectionView.isDecelerating;
    } else if ([_playModel isKindOfClass:[SJUITableViewHeaderFooterViewPlayModel class]]) {
        SJUITableViewHeaderFooterViewPlayModel *playModel = _playModel;
        return playModel.tableView.isDragging || playModel.tableView.isDecelerating;
    }
