...
/// 已弃用, 已改为通过KVC获取父视图
__deprecated_msg("use `playModel.superviewSelector`;") @protocol SJPlayModelPlayerSuperview
...
/// 已弃用, 已改为通过KVC获取嵌套视图
__deprecated_msg("use `playModel.nextPlayModel` and `playModel.scrollViewSelector`;") @protocol SJPlayModelNestedView
