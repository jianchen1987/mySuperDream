...
- (void)observeValueForKeyPath:(nullable NSString *)keyPath ofObject:(nullable id)object change:(nullable NSDictionary<NSKeyValueChangeKey, id> *)change context:(nullable void *)context {
    ...
    if (context == &kStatus || context == &kPlaybackLikelyToKeepUp || context == &kPlaybackBufferEmpty || context == &kPlaybackBufferFull || context == &kTimeControlStatus) {
        [self _toEvaluating];
...
- (void)_loadedTimeRangesDidChange {
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        if (self.timeControlStatus == SJPlaybackTimeControlStatusWaitingToPlay && self.reasonForWaitingToPlay == SJWaitingToMinimizeStallsReason && playerItem.isPlaybackBufferEmpty == false) {
