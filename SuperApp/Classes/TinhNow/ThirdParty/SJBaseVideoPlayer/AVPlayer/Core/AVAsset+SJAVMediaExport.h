...
// - preview images -
- (void)sj_generatePreviewImagesWithMaxItemSize:(CGSize)itemSize count:(NSUInteger)count completionHandler:(void (^)(AVAsset *a, NSArray<UIImage *> *_Nullable images, NSError *_Nullable error))block;
