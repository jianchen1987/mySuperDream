...
#define SJUT_SET_ATTRIBUTE_VALUE(__attr__, __value__) \
    if (__attr__ != nil)                              \
        m.__attr__ = __attr__.__value__;
...
#define SJUT_SET_ATTRIBUTE_COMMON_VALUE(__attr__) \
    if (__attr__ == nil)                          \
        __attr__ = recorder->__attr__;
...
#define SJUT_SET_PARAGRAPH_ATTRIBUTE_NSNumber(__attr__) \
    if (paragraphAttributes.__attr__ != 0)              \
        __attr__ = @(paragraphAttributes.__attr__);
