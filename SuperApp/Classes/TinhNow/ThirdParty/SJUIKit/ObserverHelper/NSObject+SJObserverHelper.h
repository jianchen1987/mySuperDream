...
extern SJKVOObserverToken sjkvo_observe(id target, NSString *keyPath, SJKVOObservedChangeHandler handler);

/// Add Observer (autoremove) [target, keyPath, options, change]
extern SJKVOObserverToken __attribute__((overloadable)) sjkvo_observe(id target, NSString *keyPath, NSKeyValueObservingOptions options, SJKVOObservedChangeHandler handler);

/// Remove Observer
extern void sjkvo_remove(id target, SJKVOObserverToken token);
