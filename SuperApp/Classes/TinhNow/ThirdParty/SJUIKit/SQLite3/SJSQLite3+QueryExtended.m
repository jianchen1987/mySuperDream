...
/// @return                 返回满足条件的对象集合. 如果条件不满足, 则返回nil.
///
- (nullable NSArray *)objectsForClass:(Class)cls
                           conditions:(nullable NSArray<SJSQLite3Condition *> *)conditions
                              orderBy:(nullable NSArray<SJSQLite3ColumnOrder *> *)orders
                                range:(NSRange)range
                                error:(NSError **)error {
...
- (nullable NSArray<SJSQLite3RowData *> *)_rowDataForClass:(Class)cls
                                             resultColumns:(nullable NSArray<NSString *> *)columns
                                                conditions:(nullable NSArray<SJSQLite3Condition *> *)conditions
                                                   orderBy:(nullable NSArray<SJSQLite3ColumnOrder *> *)orders
                                                     range:(NSRange)range
                                                     error:(NSError **)error {
...
/// @return                 返回满足条件的对象集合. 如果条件不满足, 则返回nil.
///
- (nullable NSArray<NSDictionary *> *)queryDataForClass:(Class)cls
                                          resultColumns:(nullable NSArray<NSString *> *)columns
                                             conditions:(nullable NSArray<SJSQLite3Condition *> *)conditions
                                                orderBy:(nullable NSArray<SJSQLite3ColumnOrder *> *)orders
                                                  error:(NSError **)error {
...
- (nullable NSArray<NSDictionary *> *)queryDataForClass:(Class)cls
    ...
    if (columns.count == 0) {
        ...
        for (NSString *column in columns) {
            ...
            if (info.associatedTableInfo != nil)
                [m addObject:info];
        }
        if (m.count != 0)
            columnsOfAssociatedTables = m.copy;
    }
