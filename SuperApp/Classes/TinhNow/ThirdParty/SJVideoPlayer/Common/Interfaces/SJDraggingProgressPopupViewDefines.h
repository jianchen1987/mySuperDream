...
typedef NS_ENUM(NSUInteger, SJDraggingProgressPopupViewStyle) { SJDraggingProgressPopupViewStyleNormal, SJDraggingProgressPopupViewStyleFullscreen, SJDraggingProgressPopupViewStyleFitOnScreen };
