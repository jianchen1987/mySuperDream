...
extern void sj_view_makeAppear(NSArray<UIView *> *views, BOOL animated, void (^_Nullable completionHandler)(void));
extern void __attribute__((overloadable)) sj_view_makeAppear(UIView *view, BOOL animated);
extern void __attribute__((overloadable)) sj_view_makeAppear(UIView *view, BOOL animated, void (^_Nullable completionHandler)(void));
extern void __attribute__((overloadable)) sj_view_makeAppear(NSArray<UIView *> *views, BOOL animated);

extern void sj_view_makeDisappear(NSArray<UIView *> *views, BOOL animated, void (^_Nullable completionHandler)(void));
extern void __attribute__((overloadable)) sj_view_makeDisappear(UIView *view, BOOL animated);
extern void __attribute__((overloadable)) sj_view_makeDisappear(UIView *view, BOOL animated, void (^_Nullable completionHandler)(void));
extern void __attribute__((overloadable)) sj_view_makeDisappear(NSArray<UIView *> *views, BOOL animated);
