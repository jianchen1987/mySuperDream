...
- (void)setLineColor:(nullable UIColor *)lineColor {
    ...
    _gradientLayer.colors = @[(id)[UIColor colorWithWhite:0.001 alpha:0.001].CGColor, (id)[_lineColor colorWithAlphaComponent:0.25].CGColor, (id)_lineColor.CGColor];
}
...
- (void)layoutSubviews {
    ...
    self.shapeLayer.path =
        [UIBezierPath bezierPathWithArcCenter:CGPointMake(width * 0.5 - _lineWidth, height * 0.5 - _lineWidth) radius:(width - _lineWidth) * 0.5 startAngle:0 endAngle:M_PI * 2 clockwise:YES].CGPath;
}
