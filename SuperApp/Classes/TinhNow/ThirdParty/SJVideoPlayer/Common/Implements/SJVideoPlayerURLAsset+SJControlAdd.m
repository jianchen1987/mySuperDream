...
- (nullable instancetype)initWithAttributedTitle:(NSAttributedString *)title URL:(NSURL *)URL playModel:(__kindof SJPlayModel *)playModel {
    return [self initWithAttributedTitle:title URL:URL startPosition:0 playModel:playModel];
}

- (nullable instancetype)initWithAttributedTitle:(NSAttributedString *)title URL:(NSURL *)URL startPosition:(NSTimeInterval)startPosition playModel:(__kindof SJPlayModel *)playModel {
    if (URL == nil)
        return nil;
    self = [self initWithURL:URL startPosition:startPosition playModel:playModel];
    if (self) {
