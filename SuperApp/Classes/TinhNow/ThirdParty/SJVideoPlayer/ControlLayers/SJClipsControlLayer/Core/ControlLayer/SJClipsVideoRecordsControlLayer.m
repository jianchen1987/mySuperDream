//
//  SJClipsVideoRecordsControlLayer.m
//  SJVideoPlayer
//
...
@interface SJClipsVideoRecordsControlLayer ()
...
@property (nonatomic, strong, readonly) SJClipsVideoCountDownView *countDownView;
...
@implementation SJClipsVideoRecordsControlLayer
...
- (void)_addItemToBottomAdapter {
    ...
    _countDownView = [[SJClipsVideoCountDownView alloc] initWithFrame:CGRectZero];
