...
@implementation SJClipsButtonContainerView
- (instancetype)initWithFrame:(CGRect)frame buttonSize:(CGSize)size {
    self = [super initWithFrame:frame];
    if (self) {
        _button = [SJClipsBackButton buttonWithType:UIButtonTypeCustom];
...
- (void)clickedBackBtn:(UIButton *)btn {
    if (_clickedBackButtonExeBlock)
        _clickedBackButtonExeBlock(self);
}
@end
