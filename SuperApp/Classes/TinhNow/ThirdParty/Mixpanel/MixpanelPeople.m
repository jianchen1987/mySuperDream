...
- (void)unset:(NSArray *)properties {
    ...
    for (id __unused v in properties) {
        NSAssert([v isKindOfClass:[NSString class]], @"%@ unset property names should be NSString. found: %@", self, v);
    }
...
- (void)increment:(NSDictionary *)properties {
    ...
    for (id __unused v in properties.allValues) {
        NSAssert([v isKindOfClass:[NSNumber class]], @"%@ increment property values should be NSNumber. found: %@", self, v);
    }
...
- (void)union:(NSDictionary *)properties {
    NSAssert(properties != nil, @"properties must not be nil");
    for (id __unused v in properties.allValues) {
        NSAssert([v isKindOfClass:[NSArray class]], @"%@ union property values should be NSArray. found: %@", self, v);
    }
