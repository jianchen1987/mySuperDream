//
//  SALoginByVerificationCodeView.m
//  SuperApp
//
...
@interface SALoginByVerificationCodeView () <HDUnitTextFieldDelegate>
/// 标题
...
@implementation SALoginByVerificationCodeView
...
- (UILabel *)headerDetailLabel {
    if (!_headerDetailLabel) {
        ...
        NSString *tips = [NSString stringWithFormat:SALocalizedString(@"login_new_GetVerificationCode_tip", @"我们已向你的手机尾号%@发送6位验证码，请查看短信并输入"), phoneTail];
