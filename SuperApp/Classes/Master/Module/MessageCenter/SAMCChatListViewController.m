...
@interface SAMCChatListViewController () <UITableViewDelegate, UITableViewDataSource, KSInstMsgChatProtocol>
/// 列表
...
- (void)hd_setupNavigation {
    self.boldTitle = SALocalizedString(@"mc_Chat_conversation", @"聊天信息");
...
- (void)hd_setupViews {
    ...
    self.miniumGetNewDataDuration = 0.1;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SAMCChatListCell *cell = [SAMCChatListCell cellWithTableView:tableView];
