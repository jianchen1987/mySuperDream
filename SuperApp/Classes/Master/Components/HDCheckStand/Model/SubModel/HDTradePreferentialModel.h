...
/**
 优惠信息模型
 */
@interface HDTradePreferentialModel : SACodingModel
@property (nonatomic, copy) SACurrencyType ableCurrencyType;    ///< 可用币种: 10-KHR, 11-USD, 12-USD/KHR
...
@property (nonatomic, assign) HDTradePreferentialStatus usable; ///< 可用状态(0-不可用,1-可用)
@property (nonatomic, copy) WMCouponTicketSceneType origin;     ///< 优惠券归属类型 10-平台券 11-商户券 12-平台+商户券
