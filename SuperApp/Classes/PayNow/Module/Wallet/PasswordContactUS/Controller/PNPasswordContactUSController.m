//
//  PNPasswordContactUSController.m
//  SuperApp
//
...
@interface PNPasswordContactUSController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation PNPasswordContactUSController
...
- (PNOperationButton *)button {
    if (!_button) {
        ...
        [_button addTouchUpInsideHandler:^(UIButton *_Nonnull btn) {
            ...
            [HDMediator.sharedInstance navigaveToPayNowForgotPasswordVerifySMSCodeVC:@{
