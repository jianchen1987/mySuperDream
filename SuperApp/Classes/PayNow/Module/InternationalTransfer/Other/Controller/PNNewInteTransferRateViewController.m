//
//  PNNewInteTransferRateViewController.m
//  SuperApp
//
...
@interface PNNewInteTransferRateViewController () <HDCategoryViewDelegate, HDCategoryListContainerViewDelegate, HDCategoryTitleViewDataSource>
/// 标题滚动 View
...
@implementation PNNewInteTransferRateViewController
...
- (id<HDCategoryListContentViewDelegate>)listContainerView:(HDCategoryListContainerView *)listContainerView initListForIndex:(NSInteger)index {
    if (index == 0) {
        PNInterTransferRateController *fvc = [[PNInterTransferRateController alloc] initWithRouteParameters:@{
