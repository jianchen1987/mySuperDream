...
@interface HDWebFeatureContacts () <ABPeoplePickerNavigationControllerDelegate, CNContactPickerDelegate>
...
- (void)showAuthFailAlert {
    ...
    [NAT showAlertWithMessage:HDLocalizedString(@"ALERT_MSG_CONCAT_PRIVACY", @"请在手机'设置'中允许'ViPay'访问您的通讯录", nil)
