...
//            [HDTips showWithText:HDLocalizedString(@"hint_link_copied", @"链接已复制，快去分享吧", nil) inView:self.viewController.view hideAfterDelay:2].toastPosition = HDToastViewPositionBottom;
...
//
//        // 添加复制链接和扫码分享
//        HDSocialShareCellModel *model = [HDSocialShareCellModel modelWithTitle:HDLocalizedString(@"copy_link", @"复制链接", nil)
...
//            HDShareImageAlertView *qrCodeAlertView = [HDShareImageAlertView alertViewWithTitle:HDLocalizedString(@"invite_friends_to_vipay", @"邀请好友加入ViPay", nil)
//            subTitle:HDLocalizedString(@"scan_to_register", @"用手机扫二维码，马上完成注册", nil) tipStr:HDLocalizedString(@"tips_for_iphone_user", @"（iPhone用户建议用手机自带相机打开）", nil)
//            cancelTitle:HDLocalizedString(@"BUTTON_TITLE_CANCEL", @"取消", @"") image:qrCodeImage config:nil]; [qrCodeAlertView show]; [HDTalkingData trackEvent:@"分享_点击"
//                                label:@"扫码分享"
//                           parameters:@{@"链接": urlModel.value,
//                                        @"来源页面": @"内部浏览器"}];
//        };
//        model = [HDSocialShareCellModel modelWithTitle:HDLocalizedString(@"scan_to_share", @"扫码分享", nil)
//                                                 image:[UIImage imageNamed:@"share_Scan_icon"]
//                                        clickedHandler:scanHandler];
//        [self.shareArray addObject:model];
//    }
//
//    HDSocialShareAlertView *shareAlertView = [HDSocialShareAlertView alertViewWithTitle:HDLocalizedString(@"BUTTON_TITLE_SHARE", @"分享", @"")
//                                                                            cancelTitle:HDLocalizedString(@"BUTTON_TITLE_CANCEL", @"取消", @"")
...
//                                if (error) {
//                                    [NAT showAlertWithMessage:HDLocalizedString(@"share_fail", @"分享失败", nil)
//                                                  buttonTitle:HDLocalizedString(@"BUTTON_TITLE_CONFIRM", @"确定", @"")
...
//                                } else {
//                                    [NAT showAlertWithMessage:HDLocalizedString(@"share_succ", @"分享成功", nil)
//                                                  buttonTitle:HDLocalizedString(@"BUTTON_TITLE_CONFIRM", @"确定", @"")
//                                                      handler:^(HDAlertView *alertView, HDAlertViewButton *button) {
//                                                          [alertView dismiss];
//                                                      }];
...
//            HDSocialShareCellModel *model = [HDSocialShareCellModel modelWithTitle:HDLocalizedString(name, channel, nil)
