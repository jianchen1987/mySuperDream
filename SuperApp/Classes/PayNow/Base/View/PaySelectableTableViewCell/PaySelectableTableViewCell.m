...
@interface PaySelectableTableViewCell ()
/// 选中按钮
...
@implementation PaySelectableTableViewCell
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated {
    ...
    if (selected) {
        self.textLabel.textColor = self.model.selectedTextColor;
        self.textLabel.font = self.model.selectedTextFont;
    } else {
        self.textLabel.textColor = self.model.textColor;
        self.textLabel.font = self.model.textFont;
    }
}
...
#pragma mark - setter
- (void)setModel:(PaySelectableTableViewCellModel *)model {
    _model = model;
    ...
    if (model.selectedCheckImage && model.checkImage) {
        [self.selectedBTN setImage:model.selectedCheckImage forState:UIControlStateSelected];
        [self.selectedBTN setImage:model.checkImage forState:UIControlStateNormal];
    }
