...
#import "SAModel.h"
#import "HDCouponModel.h"
#import "payTypedef.h"


@interface HDBillListModel : SAModel
...
@property (nonatomic, assign) HDOrderStatus status;
@property (nonatomic, copy) NSString *title;
@property (nonatomic, copy) NSString *tmFinished;
@property (nonatomic, copy) NSString *tradeNo;
@property (nonatomic, assign) HDTransType tradeType;
...
@property (nonatomic, assign) HDTradeSubTradeType subTradeType;

@property (nonatomic, strong) NSMutableArray<HDCouponModel *> *couponList;
