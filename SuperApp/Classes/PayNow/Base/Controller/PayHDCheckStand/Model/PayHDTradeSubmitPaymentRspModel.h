//
//  PayHDTradeSubmitPaymentRspModel.h
//  customer
//
...
/**
 支付返回模型
 */
@interface PayHDTradeSubmitPaymentRspModel : HDJsonRspModel
@property (nonatomic, copy) NSArray<PayHDTradeSubmitPreferentialModel *> *couponList; ///< 优惠信息
...
@property (nonatomic, assign) PNOrderStatus status;                                   ///< 收银流水状态
