...
typedef void (^PNInfoViewModelVoidBlock)(void);

/// 布局方式
typedef NS_ENUM(NSUInteger, PNInfoViewAlignType) {
    PNInfoViewAlignTypeHorizontal = 0, ///< 水平
    PNInfoViewAlignTypeVertical        ///< 垂直
};


@interface PNInfoViewModel : NSObject
...
@property (nonatomic, copy, nullable) NSString *bottomTipsText; ///< 底部提示文本 【布局依赖于keyButton， 必须要设置keyText】
@property (nonatomic, strong) UIFont *bottomTipsFont;           ///< 底部提示文本字体
@property (nonatomic, strong) UIColor *bottomTipsColor;         ///< 底部提示文本颜色
...
@property (nonatomic, assign) PNInfoViewAlignType alignType;         ///< 布局方式
...
@property (nonatomic, copy) PNInfoViewModelVoidBlock clickedLeftImageHandler;           ///< 点击左图事件
@property (nonatomic, copy, nullable) PNInfoViewModelVoidBlock clickedKeyButtonHandler; ///< 点击key事件
@property (nonatomic, copy) PNInfoViewModelVoidBlock clickedValueButtonHandler;         ///< 点击value事件
@property (nonatomic, copy) PNInfoViewModelVoidBlock clickedRightButtonHandler;         ///< 点击最右按钮事件
@property (nonatomic, copy, nullable) PNInfoViewModelVoidBlock eventHandler;            ///< 事件处理，优先级最高，需要设置 enableTapRecognizer 为 YES
@end
