...
#define kPickerViewHeight (kScreenWidth * (274 / 375.0))


@interface PNTimePickerViewController ()
/// 阴影
@property (nonatomic, strong) UIView *shadowView;
@property (nonatomic, strong) PNTimePickerView *pickerView;
@end


@implementation PNTimePickerViewController
...
- (PNTimePickerView *)pickerView {
    if (!_pickerView) {
        _pickerView = [[PNTimePickerView alloc] initWithFrame:CGRectMake(0, self.view.height - 250, self.view.width, 250)];
