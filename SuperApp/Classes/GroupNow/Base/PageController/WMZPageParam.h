...
/// delegate为Responser default NO
WMZPagePropStatementAndPropSetFuncStatement(assign, WMZPageParam, BOOL, wDelegateWithResponser);
///
WMZPagePropStatementAndPropSetFuncStatement(assign, WMZPageParam, BOOL, wSonScrollCanPull);
