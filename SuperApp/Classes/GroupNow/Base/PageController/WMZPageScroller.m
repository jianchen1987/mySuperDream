...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer {
    if (self.wCustomSimultaneouslyGesture)
        return self.wCustomSimultaneouslyGesture(gestureRecognizer, otherGestureRecognizer);
    if (([NSStringFromClass(otherGestureRecognizer.view.class) isEqualToString:@"WMZPageDataView"] || [NSStringFromClass(otherGestureRecognizer.view.class) isEqualToString:@"UIScrollView"]) &&
    ...
    if ([NSStringFromClass(otherGestureRecognizer.view.class) isEqualToString:@"WMHomeCollectionView"] || [NSStringFromClass(otherGestureRecognizer.view.class) isEqualToString:@"UICollectionView"]) {
        return NO;
    }
    if (self.sonCanScroll || !self.canScroll || self.contentOffset.y < 0)
        return NO;
    return YES;
}

- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldRequireFailureOfGestureRecognizer:(UIGestureRecognizer *)otherGestureRecognizer {
    if (self.wCustomFailGesture)
        return self.wCustomFailGesture(gestureRecognizer, otherGestureRecognizer);
...
- (BOOL)pointInside:(CGPoint)point withEvent:(UIEvent *)event {
    if (self.pointInsideH && point.y <= self.pointInsideH) {
        return NO;
    }
    return YES;
}
